...
import { crearConsultorio } from "../../Src/Servicios/ConsultorioService";
...
const styles = StyleSheet.create({
    ...
    pickerContainer: {
        ...
        justifyContent: 'center',
        height: 55,
        // Eliminado overflow: 'hidden' ya que el label ya no está dentro
    },
    picker: {
        height: '100%',
        width: "100%",
    ...
    boton: {
        backgroundColor: "#28A745", // Cambiado a verde para crear
        paddingVertical: 14,
